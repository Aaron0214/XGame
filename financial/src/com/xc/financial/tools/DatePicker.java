...
public class DatePicker extends JPanel {
	...
	private Calendar select,selectDay;
	...
	public static DatePicker getInstance(Date date) {
	...
	public static DatePicker getInstance(Date date, String format) {
		return new DatePicker(date, format);
	}
	...
	private DatePicker(String format) {
	...
	private class JP1 extends JPanel {
		...
		private void initJP1() {
			...
			monthleft.setBorder(BorderFactory.createEmptyBorder(2, 5, 0, 0));
			monthright.setBorder(BorderFactory.createEmptyBorder(2, 0, 0, 5));
			...
			this.setPreferredSize(new Dimension(172, 25));
	...
	private class JP2 extends JPanel {
		...
		public JP2() {
			this.setPreferredSize(new Dimension(172, 20));
		}
 
		protected void paintComponent(Graphics g) {
			g.setFont(font);
			g.drawString("日  一  二  三  四  五  六", 8, 10);
	...
	private class JP3 extends JPanel {
		...
		public JP3() {
			...
			this.setPreferredSize(new Dimension(172, 100));
			initJP3();
		}
	...
	private class MyLabel extends JLabel implements Comparator<MyLabel>, MouseListener, MouseMotionListener {
		...
		protected void paintComponent(Graphics g) {
			...
			if (day == selectDay.get(Calendar.DAY_OF_MONTH) && month == selectDay.get(Calendar.MONTH)) {
				//如果当前日期是选择日期,则高亮显示  
			...
			if (year == now.get(Calendar.YEAR) && month == now.get(Calendar.MONTH) && day == now.get(Calendar.DAY_OF_MONTH)) {
				//当前日期灰掉
				g.setColor(new Color(183, 184, 184));
				g.fillRect(0, 0, getWidth(), getHeight());
			}
	...
	public static void main(String[] args) {
		DatePicker dateChooser1 = DatePicker.getInstance("yyyy-MM-dd HH:mm:ss");
